...
%\author{Elsevier\fnref{myfootnote}, XX}
...
\author[mymainaddress]{Hong Yang\corref{mycorrespondingauthor}}
\cortext[mycorrespondingauthor]{Corresponding author}
\ead{hong.yang@fda.hhs.gov}
...
Region \rom{4} is defined to be bounded above by $\phi/\delta$. See also Figs. \ref{fig:DA-PP-4regions} and \ref{fig:dP-PP-4regions}.}
\end{table}
...
level. This will be the underlying assumption in the following analysis on the law of mass action killing rate function. 
...
%\red{highlight the arrows with different color?}  
\label{fig:PP-DA} }
\end{figure}
