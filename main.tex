...
\caption{ \label{fig:tentative} (tentative) we find periodic solutions when using the law of mass action killing and tumor elimination sensitive to initial condition when using the dePillis-Radunskaya Law killing}
\end{figure}
...
\centerline{
    ...
    \hline
        ...
        RSS (to remove)      & 1.1320e-01 & 1.9719e-02 & 1.0038e-01 & 7.2962e-02 & 1.4243e-01 & 8.4673e-03 \\ \hline
      RSS by MRM (to remove) & 4.8800e-02 & 3.4333e-02 & 3.3667e-02 & 1.6000e-02 & 8.7000e-02 & 4.0800e-02 \\ \hline
    \end{tabular}}
...
\section{Analysis on the two types of killing functions\label{sec:Analysis-on-two}}
...
\hline 
\hline 
T cell decaying & \rom{1} \quad \begin{tikzpicture}[baseline=-5]
\draw[thick,->] (0,0) -- (0,-0.5);
\draw[thick,->] (0,0) -- (-0.5,0);
\addvmargin{1mm}
\end{tikzpicture} & \rom{4} \quad \begin{tikzpicture}[baseline=-5]
\draw[thick,->] (0,0) -- (0,-0.5);
\draw[thick,->] (0,0) -- (0.5,0);
\addvmargin{1mm}
\end{tikzpicture} \tabularnewline
\hline 
T cell growing & \rom{2} \quad \begin{tikzpicture}[baseline=0]
\draw[thick,->] (0,0) -- (0,0.5);
\draw[thick,->] (0,0) -- (-0.5,0);
\addvmargin{1mm}
\end{tikzpicture} & \rom{3} \quad \begin{tikzpicture}[baseline=0]
\draw[thick,->] (0,0) -- (0,0.5);
\draw[thick,->] (0,0) -- (0.5,0);
\addvmargin{1mm}
\end{tikzpicture}\tabularnewline
